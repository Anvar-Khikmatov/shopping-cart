      ...
      <section  className=' flex flex-col py-8 xl:py-16 bg-amber-50' >
        ...
        <div className="w-full flex flex-wrap justify-center items-center gap-6 px-(--section-mobile-px)">
          {whySectionContent.descriptionBox.map((box, i) => (
            <div key={`box-${i}`} className="bg-white h-45 xl:h-55 w-70 xl:w-80 rounded-xl xl:rounded-2xl p-6 flex flex-col justify-center items-center gap-4 shadow-[0_0_25px_1px_rgba(22,21,21,0.1)] transition-shadow duration-300 ease-in-out hover:shadow-[0_0_35px_1px_rgba(22,21,21,0.2)]">
