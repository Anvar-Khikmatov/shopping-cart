    ...
    <>
      ...
      <section className='flex flex-col  py-12 xl:py-16'>
        ...
        <div className="grid grid-cols-2 grid-rows-[8rem_7rem] md:grid-rows-[12rem_11rem] xl:grid-rows-[24rem_18rem]  gap-3 md:gap-4 xl:gap-6 px-(--section-mobile-px)">
          {/* Men Card */}
          <Link to="/shop" className="group relative rounded-xl xl:rounded-3xl overflow-hidden border border-[#a8a7a2]  transition-[transform, shadow] ease-in-out duration-300 hover:-translate-y-2  hover:shadow-xl ">
          ...
          {/* Sunglasses Card */}
          <Link to="/shop" className="col-span-2 group relative rounded-xl xl:rounded-3xl overflow-hidden border border-[#a8a7a2]  transition-[transform, shadow] ease-in-out duration-300 hover:-translate-y-2  hover:shadow-xl ">
